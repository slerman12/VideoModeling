...
class VideoGPT(pl.LightningModule):
    def __init__(self, args):
        ...
        # TODO in-house encoder/decoder trained in tandem; copy architecture (w VQ-VAE codebase?) or make differentiable
    ...
    def training_step(self, batch, batch_idx):
        ...
        with torch.no_grad():
            # TODO in-house encoder/decoder trained in tandem
